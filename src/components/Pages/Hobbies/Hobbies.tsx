    ...
    <div className="page-cont lg:mx-20 md:mx-16 mx-10 lg:my-6 md:my-5 my-4">
      ...
      <section className="flex flex-col mt-5">
        <section className="flex lg:flex-row lg:gap-4 flex-col items-center justify-evenly">
          {/* Concert */}
          <Card text={hobbies.music.text} imgSrc={hobbies.hiking.imgSrc} />
          {/* Painting */}
          <Card text={hobbies.painting.text} imgSrc={hobbies.hiking.imgSrc} />
        </section>
        <section className="flex lg:flex-row lg:gap-4 flex-col items-center justify-evenly">
          {/* Hiking */}
          <Card text={hobbies.hiking.text} imgSrc={hobbies.hiking.imgSrc} />
          {/* Gaming */}
          <Card text={hobbies.gaming.text} imgSrc={hobbies.hiking.imgSrc} />
        </section>
      </section>
    </div>
  );
